        ...
        <div className="row">
          ...
          <div className="col-md-4 mb-4">
            ...
            <div className="d-flex gap-3 mt-3">
              <a href="#" className="text-muted fs-5"><i className="fab fa-instagram"></i></a>
              <a href="#" className="text-muted fs-5"><i className="fab fa-facebook"></i></a>
              <a href="#" className="text-muted fs-5"><i className="fab fa-twitter"></i></a>
              <a href="#" className="text-muted fs-5"><i className="fab fa-linkedin"></i></a>
            </div>
          </div>
